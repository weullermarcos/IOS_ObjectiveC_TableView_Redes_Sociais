...
- (void)viewDidLoad {
    ...
    UINib *cell = [UINib nibWithNibName:@"TwitterTableViewCell" bundle:[NSBundle mainBundle]];
    [self.tableView registerNib:cell forCellReuseIdentifier:@"TwitterTableViewCell"];
}
